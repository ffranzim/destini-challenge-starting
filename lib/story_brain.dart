...
class StoryBrain {
  ...
  List<Story> get storyData => _storyData;

  String getHistory() => _storyData[_storyNumber].storyTitle;
  ...
  void nextStory(choiceNumber) {
    print("choiceNumber: ${choiceNumber.toString()}");
    print("_storyNumber: ${_storyNumber.toString()}");
